<?php
	...
	$query = "INSERT INTO students VALUES('$_POST['s_no']',$_POST[roll_no],'$_POST[name]','$_POST[father_name]',$_POST[class],'$_POST[mobile]','$_POST[email]','$_POST[password]','$_POST[remark]')";
